...
#   pf-syn-schedulingagents-conversations-{env}     — Conversation log
#   pf-syn-schedulingagents-vapi-assistants-{env}   — Vapi assistant config
#
# Usage:
#   bash env_setup/01-dynamodb.sh dev
#   bash env_setup/01-dynamodb.sh qa
...
echo "═══════════════════════════════════════════════════════════"
echo "  PF Scheduling Bot — DynamoDB Tables (env=$ENVIRONMENT)"
echo "═══════════════════════════════════════════════════════════"
echo ""
