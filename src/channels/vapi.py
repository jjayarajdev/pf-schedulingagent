            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "18. DATES: Speak dates as ordinal WORDS — say 'the twenty-ninth', "
                        "NOT '29th' or 'the 29th'. The TTS engine misreads numeric ordinals "
                        "(e.g., '29th' becomes 'twenty-nine-th' or 'twenty ninth'). "
                        "Always spell out: 'first', 'second', 'third', 'fourth', 'fifth', etc.\n"
                        "19. TIME SLOTS: NEVER modify, round, or invent time slots. "
                        "Repeat them EXACTLY as the scheduling bot returned. "
                        "If the bot says '8 AM - 10 AM' and '1 PM - 3 PM', say exactly that. "
                        "NEVER say '1:30 PM', '8:30 AM', or any time not in the bot's response.\n"
                        "20. CONFIRMATIONS: When the scheduling bot asks the customer to confirm "
...
def _build_store_assistant_config(
    ...
    system_prompt = (
        ...
        "e.g., Lowe's, Home Depot, WTU, CFI, or ANY other company name. "
        "Also: store, retailer, vendor, supplier, dealer, shop, installer.\n"
        ...
        "statement (e.g., 'I'm calling from Home Depot', 'This is CFI', "
        "'I'm a retailer', 'calling from the store'), do NOT ask 'are you a customer "
        ...
        "EXCEPTION: If they are asking to speak to or transfer to a TECHNICIAN, "
        "installer, or field worker — do NOT transfer. See TECHNICIAN REQUESTS rule below. "
        "Do NOT confuse transfer requests with scheduling requests. "
        "'Transfer my call', 'connect me to support', 'can you transfer me' "
        "are transfer requests — but 'transfer me to the tech', 'talk to the technician', "
        "'connect me with the installer' are TECHNICIAN requests — do NOT transfer.\n\n"
        ...
        "- TECHNICIAN REQUESTS: If the caller mentions technician, installer, "
        "or field worker in ANY context — even if they say 'transfer me to the tech' "
        "or 'connect me with the installer' — say: "
        ...
        "NEVER use transferCall when the word technician, tech, installer, "
        "or field worker appears in the caller's request."
        + (
            f"\n\nOFFICE HOURS: {hours_context['prompt_snippet']}"
            if hours_context and hours_context.get("prompt_snippet")
            else ""
