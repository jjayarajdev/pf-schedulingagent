...
If the customer asks to check, verify, or view their installation address, technician, or \
installer details WITHOUT mentioning scheduling, dates, or appointments, call get_project_details \
to retrieve the project info — it includes both the address and installer/technician details. \
